...
The following is a set of guidelines for contributing to Sum of the first nth term of Series in Python.
...
## How to contribute to Sum of the first nth term of Series in Python
